...
typedef enum {
  ...
  MAG_T1, MAG_T2,
  MAG_S1_COMBINEDS, MAG_S1_COMBINEDQ, MAG_S2_COMBINEDS, MAG_S2_COMBINEDQ, MAG_S3_COMBINEDS, MAG_S3_COMBINEDQ,
  MAG_S4_COMBINEDS, MAG_S4_COMBINEDQ, MAG_S5_COMBINEDS, MAG_S5_COMBINEDQ, MAG_S6_COMBINEDS, MAG_S6_COMBINEDQ,
  MAG_COUNT
} MagType;
...
typedef struct {
  ...
  size_t S1_combineds_value, S1_combinedq_value, S2_combineds_value, S2_combinedq_value, S3_combineds_value, S3_combinedq_value;
  size_t S4_combineds_value, S4_combinedq_value, S5_combineds_value, S5_combinedq_value, S6_combineds_value, S6_combinedq_value;
...
typedef struct {
  int circuits[LATT_COUNT][MAG_COUNT];
